...
interface DiscoverCigarCardProps {
  cigar: {
    id: number;
    name: string;
  ...
  variant?: 'recommended' | 'rated' | 'trending';
}

export const DiscoverCigarCard: React.FC<DiscoverCigarCardProps> = ({ cigar, variant = 'rated' }) => {
  const parseFlavors = (flavors: string | string[] | undefined): string[] => {
    ...
    try {
      ...
      return typeof flavors === 'string' 
        ? flavors.split(',').map(f => f.trim())
        : [];
    }
  };
        ...
        <CardContent className="p-0">
          <div className="relative">
            ...
            <div className="relative h-40 sm:h-48">
              ...
              {/* Rating Badge */}
              {typeof cigar.averageRating === 'number' && cigar.averageRating > 0 && (
                <CardBadge
...
export default DiscoverCigarCard;